package com.ritubrata.java.various;
...
public class CurrencyExchange {
	...
	private static void printCashChange(final String line) {
		final String[] fields = line.split(";", 2);
		final float pp = Float.parseFloat(fields[0]);
		final float ch = Float.parseFloat(fields[1]);
		System.out.println(getCashChange(pp, ch));
	}

	private static String getCashChange(final float price, final float cash) {
